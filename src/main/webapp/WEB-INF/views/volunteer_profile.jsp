			...
			<div class="main-container-inner">
				...
				<div class="main-content" style=" margin-left:0px;">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb" style="margin-top:8px;">
							<li>
								...
								<a href="" class="v_p" onClick="href_change_seven()">Volunteer</a>
							</li>
					...
					<div class="page-content">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" >
									<div class="form-group">
										<label style="width: 140px;margin-left:18%;" for="form-vname"> Volunteer Name: </label>

										<div class="col-sm-9" style="margin-left:18%;">
											<input type="text" id="form-vname" placeholder="Username" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<hr>
									<div class="space-4"></div>
								    <div>
										<label  style="float:left;width: 60px;margin-left:18%;"for="form-gender">Gender:</label>

															<select style="float:left;width: 150px;" class="form-control" id="form-gender">
																<option value="1">male</option>
																<option value="2">female</option>
																
															</select>
															
										<label  style="float:left;width: 60px;margin-left:5%;"for="form-job">Job:</label>

															<select style="float:left;width: 150px;" class="form-control" id="form-job">
																<option value="1">student</option>
																<option value="2">engineer</option>
																
															</select>
															
										<label  style="float:left;width: 60px;margin-left:5%;"for="form-age">Age:</label>

															<select style="float:left;width: 150px;" class="form-control" id="form-age">
									...
									<hr>
									<div class="form-group">
										<label style="width: 60px;margin-left:18%;" for="form-email"> Email: </label>

										<div class="col-sm-9" style="margin-left:18%;">
											<input type="text" id="form-email" placeholder="Email" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<hr>
									<div class="space-4"></div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-password"> Password Field: </label>

										<div class="col-sm-9">
											<input style="float:left;" type="password" id="form-password" placeholder="Password" class="col-xs-10 col-sm-5" />
						...
						<form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="${pageContext.request.contextPath}/fileupload/upload">
							<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-3"> Custom File Input: </label>

										<div class="col-sm-9">
											
   									
									<input type="file" name="file" id="id-input-file-2" />	<br /> <br /> <input type="submit" value="Upload">		
										</div>
									</div>
