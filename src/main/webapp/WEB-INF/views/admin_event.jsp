...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
					...
					<form class="form-horizontal" role="form">
						...
						<div align="center">
						<table id="dataGrid1" class="table table-striped table-bordered table-hover" align="center"></table>
						<div id ="pager1"></div>
						</div>
	...
	<script src="<%=request.getContextPath()%>/js/admin_event_search.js"></script>
