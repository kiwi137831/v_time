			...
			<div class="navbar-header pull-left" role="navigation">
				<ul class="nav ace-nav">
					...
					<li class="light-blue" style="margin-left: 60px;"><a
						data-toggle="dropdown" class="dropdown-toggle"  "> <span>Home</span>
					</a></li>
			...
			<div class="navbar-header pull-right" role="navigation">
				<ul class="nav ace-nav">
					<li class="light-blue" style="margin-right: 20px;"><a
						data-toggle="dropdown" class="dropdown-toggle" href="#" Onclick="profile()"> <span>
								Profile</span>
					</a></li>
					<li class="light-blue" style="margin-right: 20px;"><a
			...
			<div class="main-content" style="margin-left: 0px;">
				...
				<div class="page-content">
					...
					<form class="form-horizontal" role="form">
						<h2 align="center">Event Search</h2>
						<hr>
						...
						<div class="form-group">
							<form class="navbar-form navbar-left" role="search">
								...
								<input id="e_search"
									style="float: left;  margin-left: 15%;width: 900px; height: 40px" type="text"
						...
						<div align="center">
						<table id="dataGrid1" align="center"></table>
						<div id ="pager1"></div>
						</div>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<button class="btn btn-info" type="button"
									style="margin-left: 3%;" onClick="modify()">
									<i class="icon-ok bigger-110" ></i> Modify
								</button>

								<button class="btn" type="reset" style="margin-left: 15%;" Onclick="apply()">
									<i class="icon-undo bigger-110"></i> Apply Volunteer
								</button>
								
										<button class="btn" type="reset" style="margin-left: 10%;" Onclick="addevent()">
									<i class="icon-undo bigger-110"></i> Add Event
								</button>
...
<script src="<%=request.getContextPath()%>/js/event_search.js"></script>
