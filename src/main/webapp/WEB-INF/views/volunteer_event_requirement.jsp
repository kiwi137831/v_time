...
<head>
		...
		<title>volunteer_event_requirement</title>
		...
		<script src="<%=request.getContextPath()%>/js/volunteer_event_requirement.js"></script>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" >
									<div class="form-group">
										<label style="width: 140px;margin-left:18%;" for="form-job">Job: </label>

										<div class="col-sm-9" style="margin-left:18%;">
											<input type="text" id="form-job" placeholder="no limitation" class="col-xs-10 col-sm-5" readonly />
										</div>
									</div>
									<hr>
									...
									<div class="form-group">
										<label style="width: 140px;margin-left:18%;" for="form-gender">Gender: </label>

										<div class="col-sm-9" style="margin-left:18%;">
											<input type="text" id="form-gender" placeholder="no limitation" class="col-xs-10 col-sm-5" readonly />
										</div>
									...
									<div class="form-group">
										<label style="width: 140px;margin-left:18%;" for="form-age">Age: </label>

										<div class="col-sm-9" style="margin-left:18%;">
											<input type="text" id="form-age" placeholder="no limitation" class="col-xs-10 col-sm-5" readonly />
										</div>
									...
									<div class="form-group">
										<label style="width: 140px;margin-left:18%;" for="form-skill">Skills: </label>

										<div class="col-sm-9" style="margin-left:18%;">
											<textarea class="form-control" id="form-skill" placeholder="Skill" readonly></textarea>
										</div>
									...
									<div class="form-group">
										<label style="width: 100px;margin-left:18%;float:left" for="form-exist_num">Existing positions: </label>

										<div class="col-sm-9" style="width:200px;float:left">
											<input type="text" id="form-exist_num" placeholder="10" class="col-xs-10 col-sm-5" style="width:130px;float:left" readonly />
										</div>
										
										<label style="width: 50px;float:left" for="form-total_num">Total positions: </label>

										<div class="col-sm-9" style="width:150px;float:left">
											<input type="text" id="form-total_num" placeholder="10" class="col-xs-10 col-sm-5" style="width:130px;float:left" readonly />
										</div>
