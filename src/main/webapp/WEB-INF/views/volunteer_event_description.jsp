...
<head>
		...
		<title>volunteer_event_description</title>
		...
		<script src="<%=request.getContextPath()%>/js/volunteer_event_description.js"></script>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" >
									<div class="form-group">
										<label style="width: 140px;margin-left:18%;" for="form-ename">Name: </label>

										<div class="col-sm-9" style="margin-left:18%;">
											<input type="text" id="form-ename" placeholder="name" class="col-xs-10 col-sm-5" readonly />
										</div>
									</div>
									<hr>
									...
									<div class="form-group">
										<label style="width: 140px;margin-left:18%;" for="form-oname">Organization: </label>

										<div class="col-sm-9" style="margin-left:18%;">
											<input type="text" id="form-oname" placeholder="Organization" class="col-xs-10 col-sm-5" readonly />
										</div>
									...
									<div class="form-group">
										<label style="width: 100px;margin-left:18%;float:left" for="form-stime">Date from: </label>

										<div class="col-sm-9" style="width:200px;float:left">
											<input type="text" id="form-stime" placeholder="2017" class="col-xs-10 col-sm-5" style="width:130px;float:left" readonly />
										</div>
										
										<label style="width: 50px;float:left" for="form-etime">To: </label>

										<div class="col-sm-9" style="width:150px;float:left">
											<input type="text" id="form-etime" placeholder="2017" class="col-xs-10 col-sm-5" style="width:130px;float:left" readonly />
										</div>
									...
									<div class="form-group">
										<label style="width: 140px;margin-left:18%;" for="form-location">Location: </label>

										<div class="col-sm-9" style="margin-left:18%;">
											<input type="text" id="form-location" placeholder="Location" class="col-xs-10 col-sm-5" readonly />
										</div>
									...
									<div class="form-group">
										<label style="width: 140px;margin-left:18%;" for="form-content">Content: </label>

										<div class="col-sm-9" style="margin-left:18%;">
											<textarea class="form-control" id="form-content" placeholder="Content" readonly></textarea>
										</div>
